...
<div class="content-wrapper">
  ...
  <div class="row">
            ...
            <div class="col-md-3 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <p class="card-title text-md-center text-xl-left">Training Hub</p>
                  <div class="d-flex flex-wrap justify-content-between justify-content-md-center justify-content-xl-between align-items-center">
                    <a href="{{ route('admin.training_hub') }}"><h3 class="mb-0 mb-md-2 mb-xl-0 order-md-1 order-xl-0"> {{ $training->count() }} </h3></a> 
